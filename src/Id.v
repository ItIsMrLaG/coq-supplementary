...
Proof. intros. destruct (id_eq_dec x y). 
  - contradiction.
  - reflexivity.
Qed.
...
Proof. 
  ...
  apply Nat.lt_asymm in H3. apply H3. 
  auto. 
Qed.
...
Proof. 
  ...
  destruct id1, id2. 
  inversion H. inversion H0. 
  apply Nat.lt_nge in H3. apply H3. 
  auto. 
Qed.
...
Proof.
  intros id1 id2. destruct (gt_eq_gt_id_dec id1 id2) as [[H1|H2]|H3].
...
Proof. intros id1 id2 H. destruct (gt_eq_gt_id_dec id1 id2) as [[H1|H1]|H1].
  - left. apply H1.
  - right. contradiction.
  - right. apply H1.
Qed.
